...
export default function JayGatsby() {
 ...
 {/*animation*/}
      ...
      <div className="relative w-full h-[60vh] flex items-end justify-center text-center">
        <div
          className="absolute inset-0 bg-cover bg-center z-0"
          style={{
            backgroundImage: `url('https://i.imgur.com/scmyE6k.jpeg')`,
          }}
        ></div>
